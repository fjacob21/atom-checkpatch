...
export default {
        ...
        findSubsystem(file){
                ...
                //console.debug(atom.project.getDirectories());
                //console.debug(file, dir, files);
                while(dir.getPath() != this.linuxPath) {
        ...
        parseCheckpatch(outputs, file) {
                ...
                if (this.results.size == 0)
                        console.debug('checkpatch finish!');
                var item = [];
                var msgs = [];
